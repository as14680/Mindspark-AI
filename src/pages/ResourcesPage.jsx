    ...
    <AppShell>
      <div className="max-w-5xl mx-auto">
        <div className="mb-6">
          ...
          <p className="text-gray-500 mt-1">Curated links to the best AI learning materials on the internet.</p>
        </div>

        {/* Featured */}
        {!search && !showSaved && type === 'all' && (
          <div className="mb-8">
            <h2 className="font-bold text-gray-900 mb-3">⭐ Featured Resources</h2>
        ...
        <div className="flex flex-col sm:flex-row gap-3 mb-4">
          <input
            ...
            className="flex-1 px-4 py-2 rounded-xl border border-gray-200 text-sm focus:outline-none focus:border-brand-400 bg-white"
          />
          <button
        ...
        {filtered.length === 0 ? (
          <div className="text-center py-16 text-gray-400">
            ...
            <p>{showSaved ? 'No saved resources yet. Save some to find them here!' : 'No resources match your filters.'}</p>
          </div>
        ) : (
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4">
