    ...
    <AppShell>
      <div className="max-w-3xl mx-auto">
        ...
        <div className="flex items-center gap-2 text-sm text-gray-400 mb-4">
          <Link to="/topics" className="hover:text-gray-600">Topics</Link>
          <span>→</span>
        ...
        <div className="mb-4 flex justify-between items-center">
          <h2 className="font-bold text-gray-900">Lessons ({doneLessons}/{topic.lessons.length})</h2>
          <span className="text-sm text-gray-400">{Math.round(doneLessons / topic.lessons.length * 100)}% complete</span>
        </div>
            ...
            return (
              <Link
                ...
                className={cn(
                  ...
                  unlocked ? 'bg-white border-gray-200 hover:border-brand-300 hover:shadow-sm' :
              ...
              >
                <div className={cn(
                  ...
                  unlocked ? 'bg-brand-100 text-brand-700' :
                ...
                <div className="flex-1">
                  ...
                  <p className="text-xs text-gray-400 mt-0.5">+{lesson.xpReward} XP</p>
                </div>
                {done && <span className="text-xs text-green-600 font-medium">Done</span>}
                {unlocked && !done && <span className="text-xs text-brand-600">Start →</span>}
              </Link>
            )
          })}
        </div>
        ...
        {topic.quizId && (
          <div className="bg-white rounded-xl border border-gray-200 p-5 flex items-center justify-between">
            <div>
              <h3 className="font-bold text-gray-900">Take the Quiz</h3>
