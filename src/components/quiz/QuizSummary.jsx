...
export default function QuizSummary({ score, total, xpEarned, topicId, onRetry }) {
  ...
  return (
    <div className="text-center py-8 animate-fade-in">
      ...
      <h2 className="text-2xl font-bold text-gray-900 dark:text-white mb-1">{score}/{total} correct</h2>
      <p className="text-gray-500 dark:text-gray-400 mb-2">{pct}% score</p>
      ...
      <div className="inline-flex items-center gap-2 bg-yellow-50 dark:bg-yellow-900/30 border border-yellow-200 dark:border-yellow-700 px-4 py-2 rounded-full mb-6">
        <span className="text-yellow-500">⚡</span>
        <span className="font-bold text-yellow-700 dark:text-yellow-400">+{xpEarned} XP earned</span>
      </div>
      ...
      <div className="flex gap-3 justify-center flex-wrap">
        ...
        <Link
          to="/topics"
          className="px-5 py-2.5 rounded-xl bg-gray-900 dark:bg-gray-700 text-white text-sm font-semibold hover:bg-gray-800 dark:hover:bg-gray-600 transition-colors"
        >
          🗺️ All Topics
        </Link>
      </div>
